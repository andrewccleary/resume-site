    ...
    <div className="App">
      ...
      <div className="Experience">
        ...
        <div className="Experience-header">
          ...
          <p>Product owner for E2E Lean manufacturing digitization project – translating business requirements into User Stories and leading development efforts within Scrum team</p>
